...
{//ordena el array caja para que se mantengan después de cada ciclo en los que se elimina y agrega partes del array original
    caja.sort(
        function resta(a, b)
        {
...
function ocultarMostrarSubmenu(oculto) //variable booleana
...
{//condicion puede ser "extraer" o "saldo"
    ...
    switch(condicion)
    {
        ...
        //pongo estas dos lineas por fuera del ciclo para que me genere un solo parrafo que despues pueda eliminar
